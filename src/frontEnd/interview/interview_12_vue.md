...
- [1. Vue 有什么好处和坏处，你对他的看法是什么](#1-vue-有什么好处和坏处你对他的看法是什么)
- [2. 简单说一下 vue 的响应式原理](#2-简单说一下-vue-的响应式原理)
- [3. vue.nextTick 的原理](#3-vuenexttick-的原理)
- [4. vue computed 和 watch 的相同点和不同点](#4-vue-computed-和-watch-的相同点和不同点)
- [5. vue3 和 vue2 的区别](#5-vue3-和-vue2-的区别)
- [6. vue3 的 Composition API](#6-vue3-的-composition-api)
- [7. vue3 的 composition API 是怎么实现的？](#7-vue3-的-composition-api-是怎么实现的)
- [8. vue3 的 Composition API 和 vue2 的 Options API 的区别](#8-vue3-的-composition-api-和-vue2-的-options-api-的区别)
- [9. vue3 的 Composition API 和 react 的 hooks 的区别](#9-vue3-的-composition-api-和-react-的-hooks-的区别)
- [10. vue3 的 ref、toRef、toRefs 的区别](#10-vue3-的-reftoreftorefs-的区别)
- [11. vue3 的 ref、reactive 联系和区别](#11-vue3-的-refreactive-联系和区别)
- [12. vue 的数据流](#12-vue-的数据流)
- [13. vue 的生命周期](#13-vue-的生命周期)
- [14. vue 的组件通信](#14-vue-的组件通信)
- [15. vue 组件通信的原理](#15-vue-组件通信的原理)
- [16. vue 中模版是怎么更新的，你是怎么理解虚拟 dom 的](#16-vue-中模版是怎么更新的你是怎么理解虚拟-dom-的)
- [17. vue3 的性能优化](#17-vue3-的性能优化)
- [18. vue 中的 diff 算法](#18-vue-中的-diff-算法)
- [19. vue 中 keep-alive 的原理](#19-vue-中-keep-alive-的原理)
- [20. key 的作用，如果不写 key 会怎么样，自定义组件中的 key 有什么作用](#20-key-的作用如果不写-key-会怎么样自定义组件中的-key-有什么作用)
- [21. 怎么封装一个自己的指令](#21-怎么封装一个自己的指令)
- [22. vue3 中 reactive 是如何实现的](#22-vue3-中-reactive-是如何实现的)
- [23. MVVM 模型中的 vm 是什么，是如何实现的](#23-mvvm-模型中的-vm-是什么是如何实现的)

<!-- /TOC -->

## 1. Vue 有什么好处和坏处，你对他的看法是什么
...
- 坏处
  - 兼容性差，不支持 IE8 及以下版本
- 看法：vue 的出现解决了之前的前端开发中的很多问题，如组件化开发、数据驱动视图、双向数据绑定等，但是由于兼容性的问题，导致在一些老项目中无法使用，所以在实际开发中，还是需要根据项目的实际情况来选择合适的框架
...
- `computed`: 不可以，因为它是同步执行的
- `watch`: 可以，因为它是异步执行的

computed 的原理：通过发布订阅模式，在创建 computed 属性时候，会循环所有计算属性，每一个计算属性会创建一个 watch，当计算属性的依赖发生变化时，会触发 watch 的回调，从而触发计算属性的重新计算。
...
## 11. vue3 的 ref、reactive 联系和区别

- ref：创建一个响应式的 ref 对象，可以通过 .value 获取值
- reactive：创建一个响应式的对象

ref 只能响应基本数据类型的变化，而 reactive 可以响应对象和数组的变化，ref 内部也是通过 reactive 实现的，先判断是否是基本数据类型，如果是基本数据类型，就创建一个 ref 对象，如果不是基本数据类型，就创建一个 reactive 对象
...
## 16. vue 中模版是怎么更新的，你是怎么理解虚拟 dom 的
