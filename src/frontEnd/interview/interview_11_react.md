...
### 2. 用过高阶组件吗，什么是高阶组件，高阶组件能用来做什么

简称 HOC，是一个函数，接收一个组件作为参数，返回一个新的组件

#### 2.1. 为什么要使用高阶组件(高阶组件能用来做什么)
...
### 4. 说一下 react 的 diff 算法，和 fiber 有什么关系
...
### 9. 手写 useState、useEffect、useRef
