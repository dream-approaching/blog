...
## 6. key 的作用是什么? 为什么不能用 Index？用了会怎样? 如果不加 key 会怎样?
...
## 11. 手写 useState、useEffect、useRef
...
### 15.1. react-redux 和 redux 的关系

react-redux 是 redux 的官方绑定库，用来简化 redux 在 react 中的使用。

### 15.2. react-redux 中常用的 API
...
### 15.3. react-redux connect 的原理是什么
...
### 16.1. react-router 和 react-router-dom 的区别
...
### 16.2. react-router 的原理

react-router 是一个单页应用的路由库，它的原理是根据 url 的变化，渲染不同的组件。

### 16.3. hash 模式 和 history 模式的区别
