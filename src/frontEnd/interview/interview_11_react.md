...
### 14.1. react-redux 和 redux 的关系

react-redux 是 redux 的官方绑定库，用来简化 redux 在 react 中的使用。

### 14.2. react-redux 中常用的 API
...
### 14.3. react-redux connect 的原理是什么
...
### 15.1. react-router 和 react-router-dom 的区别
...
### 15.2. react-router 的原理

react-router 是一个单页应用的路由库，它的原理是根据 url 的变化，渲染不同的组件。

### 15.3. hash 模式 和 history 模式的区别
