...
> 了解一些最前言的技术，比如说`React Fiber`、`Vue3`、`TypeScript`、`WebAssembly`等等，这些都是前端发展的趋势，了解一些最前言的技术，可以让你在面试的时候更加有竞争力。

## 3. 如何解决 a 标签点击后 hover 事件失效的问题?
...
## 10. 知道 meta 标签有把 http 换成 https 的功能吗
...
## 11. slice、substr 和 substring 有什么区别
