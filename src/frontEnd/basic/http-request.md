...
## 15. 做过全局的请求处理吗？比如统一处理登录态、全局错误处理等

> 基于 axios、fetch 封装的请求库

## 16. http 1.0、1.1、2.0 在并发请求上有什么区别
...
## 17. http 1.1 的长连接和 http 2.0 的多路复用有什么区别
